...
# Put the path to where the checkpoint files are stored

path = "/Volumes/research1/MAIHEM_runs/Z1/High_rot_z1"#"/Users/ebuie/MAIHEM_runs/High_rot_z03"
for p in range(1):
    files = [63,96]
    for i in range(74):
        i = i + 100#files[i]
        ...
        field = ['o5pdens','n4pdens','si3pdens','si2pdens','sipdens','hdens','c3pdens','mgpdens','cpdens','c2pdens','fepdens','fe2pdens','npdens','odens','temperature','ndens','pressure','magnetic','internal','plasma_beta','mag_energy','mag_density','velz'] #
        ...
        # j index represents the field index found in ***
        # Beef up knowledge on YT plotting
        for j in range(1): 
            j = j+14
            ...
            #slc.set_cmap(field=field[j],cmap='dusk_r') #for projections
            slc.set_cmap(field[j],"RED TEMPERATURE")#"RdBu_r")W
			...
			# Adds length scale reference bar on bottom of plot
            slc.save()